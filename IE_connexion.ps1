...
#>
	...
	# connexion information (to edit)

	$username	=			"YOUR APARTMENT NUMBER"
	...
	$global:ie.visible = $true
		if (!($?))
		{
			write-host "ERREUR: Lancement d'Internet Explorer échoué."
		}
	...
	ClickElementByName "Network Access"
		...
		while ($global:ie.Busy -eq $true)
		{
			Start-Sleep -Milliseconds 1000;
		}
			if (!($?))
		{
			Write-Error "ERREUR: Login à la page impossible."
		}